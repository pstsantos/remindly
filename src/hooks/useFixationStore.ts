...
export function useFixationStore() {
  ...
  const logPractice = useCallback((
    ...
    // Remove ALL old scheduled for this pattern and rebook everything
    setScheduled(prev => {
    ...
    return { event, occurrence: futureOccurrences[0] || { id: '', date: format(addDays(new Date(), 1), 'yyyy-MM-dd'), patternId, autoGenerated: true } };
